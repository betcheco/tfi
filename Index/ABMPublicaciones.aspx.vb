Public Class ABMPublicaciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not (Page.IsPostBack) Then
            If Not Session("currentUser") Is Nothing Then
                If BLL.Usuario.CheckPermiso(Session("currentUser"), "btnABMPublicacionesSideBar") Then
                    actualizar()
                Else
    ...
    Sub actualizar()
        ...
        gridAnuncios.DataSource = BLL.Anuncio.Listar(Nothing)
